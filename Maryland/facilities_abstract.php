...
$Facility_ZIP['Abbey_Manor_Assisted_Living'] = '21921'; // Abbey Manor Assisted Living Cecil
$Facility_ZIP['Alice_B__Tawes_Nursing_and_Rehabilitation_Center'] = '21817'; // Alice B Tawes Nursing and Rehabilitation Center Somerset
$Facility_ZIP['Allegany_Health_Nursing_and_Rehabilitation'] = '21502'; // Allegany Health Nursing and Rehabilitation Allegany
$Facility_ZIP['Autumn_Lake___Arlington_West_Care_Center'] = '21215'; // Autumn Lake Arlington West Care Center Baltimore_City
$Facility_ZIP['Bayleigh_Chase___ALF'] = '21601'; // Bayleigh Chase ALF Talbot
$Facility_ZIP['Bayleigh_Chase___Nursing_Home'] = '21601'; // Bayleigh Chase Nursing Home Talbot
$Facility_ZIP['Berlin_Nursing_Home_and_Rehab'] = '21811'; // Berlin Nursing Home and Rehab Worcester
$Facility_ZIP['Bethesda_Health___Rehab_Center'] = '20814'; // Bethesda Health Rehab Center Montgomery
$Facility_ZIP['Brighton_Gardens_of_Friendship_Heights'] = '20815'; // Brighton Gardens of Friendship Heights Montgomery
$Facility_ZIP['Brightview_Crofton_Riverwalk'] = '21114'; // Brightview Crofton Riverwalk Anne_Arundel
$Facility_ZIP['Brightview_Fallsgrove___Rockville'] = '20850'; // Brightview Fallsgrove Rockville Montgomery
$Facility_ZIP['Brightview_Mays_Chapel'] = '21093'; // Brightview Mays Chapel Baltimore
$Facility_ZIP['Brightview_Senior_Living_Bel_Air'] = '21014'; // Brightview Senior Living Bel Air Harford
$Facility_ZIP['Brightview_Westminster_Ridge'] = '21157'; // Brightview Westminster Ridge Carroll
$Facility_ZIP['Brightview_Woodmont'] = '20814'; // Brightview Woodmont Montgomery
$Facility_ZIP['Buckingham_s_Choice____Assisted_Living'] = '21710'; // Buckingham s Choice Assisted Living Frederick
$Facility_ZIP['Buckingham_s_Choice____Nursing_Home'] = '21710'; // Buckingham s Choice Nursing Home Frederick
$Facility_ZIP['Caroline_County_Detention_Center'] = '21629'; // Caroline County Detention Center Caroline
$Facility_ZIP['Caroline_Nursing_and_Rehab'] = '21629'; // Caroline Nursing and Rehab Caroline
$Facility_ZIP['Carriage_Hill_of_Bethesda'] = '20814'; // Carriage Hill of Bethesda Montgomery
$Facility_ZIP['Cecil_County_Detention_Center'] = '21921'; // Cecil County Detention Center Cecil
$Facility_ZIP['Cedar_Creek_Memory_Care_Homes__Hillwood'] = '20817'; // Cedar Creek Memory Care Homes Hillwood Montgomery
$Facility_ZIP['Country_Meadows'] = '21704'; // Country Meadows Frederick
$Facility_ZIP['Crofton_Care_and_Rehabilitation_Center'] = '21114'; // Crofton Care and Rehabilitation Center Anne_Arundel
$Facility_ZIP['Egle_Nursing_Home'] = '21539'; // Egle Nursing Home Allegany
$Facility_ZIP['Elmcroft_Assisted_Living'] = '21740'; // Elmcroft Assisted Living Washington
$Facility_ZIP['Forest_Heights_Assisted_Living'] = '21050'; // Forest Heights Assisted Living Harford
$Facility_ZIP['Forest_Hill_Health_and_Rehab'] = '21050'; // Forest Hill Health and Rehab Harford
$Facility_ZIP['Frederick_County_Adult_Detention_Center'] = '21704'; // Frederick County Adult Detention Center Frederick
$Facility_ZIP['Genesis_Glade_Valley'] = '21793'; // Genesis Glade Valley Frederick
$Facility_ZIP['Hampton_Meadows_Rolling_Meadows_Woodholme_Springs'] = '21286'; // Hampton Meadows Rolling Meadows Woodholme Springs Baltimore
$Facility_ZIP['HeartFields_Assisted_Living_at_Easton'] = '21601'; // HeartFields Assisted Living at Easton Talbot
$Facility_ZIP['Hebron_Care_Center_1_and_2'] = '20772'; // Hebron Care Center 1 and 2 Prince_Georges
$Facility_ZIP['Inspirations__Linthicum_'] = '21090'; // Inspirations Linthicum Anne_Arundel
$Facility_ZIP['Kent_County_Detention_Center'] = '21620'; // Kent County Detention Center Kent
$Facility_ZIP['Levindale_Hebrew_Geriatric_Center_LTC'] = '21215'; // Levindale Hebrew Geriatric Center LTC Baltimore_City
$Facility_ZIP['Lower_Eastern_Shore_Children_s_Center'] = '21801'; // Lower Eastern Shore Children s Center Wicomico
$Facility_ZIP['Manor_Care_Potomac'] = '20854'; // Manor Care Potomac Montgomery
$Facility_ZIP['Morningside_House_of_Satyr_Hill'] = '21234'; // Morningside House of Satyr Hill Baltimore
$Facility_ZIP['Mountain_City_Care_for_Rehabilitation_and_Nursing'] = '21502'; // Mountain City Care for Rehabilitation and Nursing Allegany
$Facility_ZIP['Riderwood_Village'] = '20904'; // Riderwood Village Prince_Georges
$Facility_ZIP['Robinwood_Assisted_Living'] = '21742'; // Robinwood Assisted Living Washington
$Facility_ZIP['Saint_Stephens_Green'] = '21093'; // Saint Stephens Green Baltimore
$Facility_ZIP['Sommerford_Place'] = '21045'; // Sommerford Place Howard
$Facility_ZIP['Sterling_Care_at_Riverside'] = '21017'; // Sterling Care at Riverside Harford
$Facility_ZIP['Summerford_House_Place'] = '21740'; // Summerford House Place Washington
$Facility_ZIP['Sunrise_at_Chevy_Chase'] = '20910'; // Sunrise at Chevy Chase Montgomery
$Facility_ZIP['Sunrise_of_Frederick'] = '21702'; // Sunrise of Frederick Frederick
$Facility_ZIP['Symphony_Manor_at_Roland_Park'] = '21210'; // Symphony Manor at Roland Park Baltimore_City
$Facility_ZIP['The_Maples_of_Towson'] = '21204'; // The Maples of Towson Baltimore
$Facility_ZIP['Villa_Rosa'] = '20721'; // Villa Rosa Prince_Georges
$Facility_ZIP['Vindobona_Nursing_and_Rehabilitation_Center'] = '21703'; // Vindobona Nursing and Rehabilitation Center Frederick
$Facility_ZIP['Williamsport_Retirement_Village'] = '21795'; // Williamsport Retirement Village Washington
$Facility_ZIP['Woodlands_Assisted_Living_Ocean_Pines'] = '21811'; // Woodlands Assisted Living Ocean Pines Worcester
...
while ($d = mysqli_fetch_array($r)){
  ...
  foreach ($array['features'] as $key => $value){
	  ...
	  $master_array[$Facility_Name]['Number_of_Resident_Deaths'] = $value['attributes']['Number_of_Resident_Deaths'];
	  $master_array[$Facility_Name]['Number_of_Staff_Deaths'] = $value['attributes']['Number_of_Staff_Deaths'];
	  /*
