...
<li>United States
	<ul>
		...
		$q = "SELECT distinct name_of_location FROM coronavirus_populations where name_of_location <> 'Arizona' and state_of_location = 'Arizona' order by name_of_location";
		$r = $core->query($q);
