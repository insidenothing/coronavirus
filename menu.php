...
<div class="container"><!--- Open Container -->
	...
	<ul class="nav nav-pills">
		...
		<li role='presentation' <?PHP if($_SERVER['REQUEST_URI'] == '/phase1.php?state=Florida'){ echo "class='active'"; } ?> ><a href="phase1.php?state=Florida">Reopen Florida Status</a></li>		<li role='presentation' <?PHP if($_SERVER['REQUEST_URI'] == '/florida_zip.php'){ echo "class='active'"; } ?> ><a href="florida_zip.php">FL Zip Codes</a></li>
