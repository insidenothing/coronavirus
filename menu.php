...
ddtreemenu.createTree("treemenu1", true)
	...
	<div style='position:absolute; top:60px; right:10px;'><fb:login-button id='public' scope="public_profile,email" onlogin="checkLoginState();"></fb:login-button></div>	
	<div style='position:absolute; top:60px; right:10px;'><fb:logout-button id='private' scope="public_profile,email" onlogout="LogoutState();"></fb:logout-button></div>	
