...
<div class="row">
	...
	while ($d = mysqli_fetch_array($r)){
		echo "<li>".$d['zip_code']." ".$d['day7change_percentage']."%</li>";
	}
	?>
  </div>
	<div class="col-sm-3">
	...
	$r = $core->query($q);
	while ($d = mysqli_fetch_array($r)){
		echo "<li>".$d['zip_code']." ".$d['day14change_percentage']."%</li>";
	}
	?>
  </div>
  <div class="col-sm-3">
	...
	$r = $core->query($q);
	while ($d = mysqli_fetch_array($r)){
		echo "<li>".$d['zip_code']." ".$d['day30change_percentage']."%</li>";
	}
	?>
  </div>
	<div class="col-sm-3">
   ...
   <?PHP
	...
	$r = $core->query($q);
	while ($d = mysqli_fetch_array($r)){
		echo "<li>".$d['zip_code']." ".$d['day45change_percentage']."%</li>";
	}
	?>
  </div>
</div>
