<?PHP
$page_description = "Florida COVID 19 Spike Monitor";
...
<h1>Florida COVID 19 Spike Monitor - % Change of Infections</h1>
<?PHP
ob_start();
$counter['same']=0;
$counter['up']=0;
...
<div class="row">
	...
	<div class="col-sm-2">
		...
		<?PHP
		$q = "SELECT day7change_percentage, zip_code, percentage_direction FROM coronavirus_zip where report_date = '$date' and day7change_percentage > '1000' and state_name = 'florida' order by day7change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
		...
		<?PHP
//		$q = "SELECT day7change_percentage, zip_code, percentage_direction FROM coronavirus_zip where report_date = '$date' and day7change_percentage > '100' and day7change_percentage < '1000' and state_name = 'florida' order by day7change_percentage DESC";
	...
	<div class="col-sm-2">
		...
		<?PHP
		$q = "SELECT report_count, day7change_percentage, zip_code, percentage_direction FROM coronavirus_zip where report_date = '$date' and day7change_percentage > '50' and day7change_percentage < '100' and state_name = 'florida'  order by day7change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
		...
		<?PHP
		$q = "SELECT report_count, day7change_percentage, zip_code, percentage_direction FROM coronavirus_zip where report_date = '$date' and day7change_percentage > '30' and day7change_percentage < '50' and state_name = 'florida'  order by day7change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
		...
		<?PHP
		$q = "SELECT report_count, day7change_percentage, zip_code, percentage_direction FROM coronavirus_zip where report_date = '$date' and day7change_percentage > '20' and day7change_percentage < '30' and state_name = 'florida'  order by day7change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
		...
		<?PHP
		$q = "SELECT report_count, day7change_percentage, zip_code, percentage_direction FROM coronavirus_zip where report_date = '$date' and day7change_percentage > '10' and day7change_percentage < '20' and state_name = 'florida' order by day7change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
		...
		<?PHP
		$q = "SELECT report_count, day7change_percentage, zip_code, percentage_direction FROM coronavirus_zip where report_date = '$date' and day7change_percentage > '0' and day7change_percentage < '10' and state_name = 'florida' order by day7change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
...
<div class="row">
	<div class="col-sm-2">
	    ...
	    <?PHP
		$q = "SELECT report_count, day14change_percentage, zip_code, percentage_direction14 FROM coronavirus_zip where report_date = '$date' and day14change_percentage > '1000' and state_name = 'florida' order by day14change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
	    ...
	    <?PHP
		$q = "SELECT report_count, day14change_percentage, zip_code, percentage_direction14 FROM coronavirus_zip where report_date = '$date' and day14change_percentage > '100' and day14change_percentage < '1000' and state_name = 'florida' order by day14change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
	    ...
	    <?PHP
		$q = "SELECT report_count, day14change_percentage, zip_code, percentage_direction14 FROM coronavirus_zip where report_date = '$date' and day14change_percentage > '50' and day14change_percentage < '100' and state_name = 'florida' order by day14change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
	    ...
	    <?PHP
		$q = "SELECT report_count, day14change_percentage, zip_code, percentage_direction14 FROM coronavirus_zip where report_date = '$date' and day14change_percentage > '20' and day14change_percentage < '50' and state_name = 'florida' order by day14change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
	    ...
	    <?PHP
		$q = "SELECT report_count, day14change_percentage, zip_code, percentage_direction14 FROM coronavirus_zip where report_date = '$date' and day14change_percentage > '10' and day14change_percentage < '20' and state_name = 'florida' order by day14change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
	    ...
	    <?PHP
		$q = "SELECT report_count, day14change_percentage, zip_code, percentage_direction14 FROM coronavirus_zip where report_date = '$date' and day14change_percentage > '0' and day14change_percentage < '10' and state_name = 'florida' order by day14change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
...
<div class="row">	
	<div class="col-sm-2">
	    ...
	    <?PHP
		$q = "SELECT report_count, day30change_percentage, zip_code, percentage_direction30 FROM coronavirus_zip where report_date = '$date' and day30change_percentage > '1000' and state_name = 'florida' order by day30change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
	    ...
	    <?PHP
		$q = "SELECT report_count, day30change_percentage, zip_code, percentage_direction30 FROM coronavirus_zip where report_date = '$date' and day30change_percentage > '100' and day30change_percentage < '1000' and state_name = 'florida' order by day30change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
	    ...
	    <?PHP
		$q = "SELECT report_count, day30change_percentage, zip_code, percentage_direction30 FROM coronavirus_zip where report_date = '$date' and day30change_percentage > '50' and day30change_percentage < '100' and state_name = 'florida' order by day30change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
	    ...
	    <?PHP
		$q = "SELECT report_count, day30change_percentage, zip_code, percentage_direction30 FROM coronavirus_zip where report_date = '$date' and day30change_percentage > '20' and day30change_percentage < '50' and state_name = 'florida' order by day30change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
	    ...
	    <?PHP
		$q = "SELECT report_count, day30change_percentage, zip_code, percentage_direction30 FROM coronavirus_zip where report_date = '$date' and day30change_percentage > '10' and day30change_percentage < '20' and state_name = 'florida' order by day30change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
	    ...
	    <?PHP
		$q = "SELECT report_count, day30change_percentage, zip_code, percentage_direction30 FROM coronavirus_zip where report_date = '$date' and day30change_percentage > '0' and day30change_percentage < '10' and state_name = 'florida' order by day30change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
...
<div class="row">
	<div class="col-sm-2">
	   ...
	   <?PHP
		$q = "SELECT report_count, day45change_percentage, zip_code, percentage_direction45 FROM coronavirus_zip where report_date = '$date' and day45change_percentage > '1000' and state_name = 'florida' order by day45change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
	   ...
	   <?PHP
		$q = "SELECT report_count, day45change_percentage, zip_code, percentage_direction45 FROM coronavirus_zip where report_date = '$date' and day45change_percentage > '100' and day45change_percentage < '1000' and state_name = 'florida' order by day45change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
	   ...
	   <?PHP
		$q = "SELECT report_count, day45change_percentage, zip_code, percentage_direction45 FROM coronavirus_zip where report_date = '$date' and day45change_percentage > '50' and day45change_percentage < '100' and state_name = 'florida' order by day45change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
	   ...
	   <?PHP
		$q = "SELECT report_count, day45change_percentage, zip_code, percentage_direction45 FROM coronavirus_zip where report_date = '$date' and day45change_percentage > '20' and day45change_percentage < '50' and state_name = 'florida' order by day45change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
	   ...
	   <?PHP
		$q = "SELECT report_count, day45change_percentage, zip_code, percentage_direction45 FROM coronavirus_zip where report_date = '$date' and day45change_percentage > '10' and day45change_percentage < '20' and state_name = 'florida' order by day45change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
	...
	<div class="col-sm-2">
	   ...
	   <?PHP
		$q = "SELECT report_count, day45change_percentage, zip_code, percentage_direction45 FROM coronavirus_zip where report_date = '$date' and day45change_percentage > '0' and day45change_percentage < '10' and state_name = 'florida' order by day45change_percentage DESC";
		$r = $core->query($q);
		while ($d = mysqli_fetch_array($r)){
			$zip_c = $d['zip_code'];
			$name = $zipcode[$zip_c];
